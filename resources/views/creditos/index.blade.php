...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Creditos</h1>
            ...
            <table class="table table-bordered table-striped dt-responsive" id="dataTable" width="100%" cellspacing="0">
                ...
                @foreach($creditos as $credito)
                    <tr>
                        ...
                        <td>{{$credito->noperacion}}</td>
                        <td>{{$credito->marca}}</td>
                        <td>{{$credito->modelo}}</td>
                        <td>
                        @if($credito->estado_activo)
                        ...
                        <td>
                            <a href="{{route('creditos.show', ['credito' => $credito->id])}}" class="btn btn-info btn-sm" role="button" title="Mostrar"><i class="fa fa-eye"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
