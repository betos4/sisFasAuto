                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('numcontrato') is-invalid @enderror" id="numcontrato" name="numcontrato" placeholder="Número contrato" required="required" value="{{old('numcontrato')}}">
                        @error('numcontrato')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tipocontrato') is-invalid @enderror" id="tipocontrato" name="tipocontrato" placeholder="Tipo contrato" required="required" value="{{old('tipocontrato')}}">
                        @error('tipocontrato')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('valorgarantia') is-invalid @enderror" id="valorgarantia" name="valorgarantia" placeholder="Valor garantía" required="required" value="{{old('valorgarantia')}}">
                        @error('valorgarantia')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="fechainicio" type="date" class="form-control @error('fechainicio') is-invalid @enderror" name="fechainicio" value="{{ old('fechainicio') }}">
                        @error('fechainicio')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
